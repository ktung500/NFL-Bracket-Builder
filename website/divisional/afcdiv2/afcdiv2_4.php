...
<html>
	...
	<body scroll="no" style="overflow: hidden">
		...
		<h1>AFC Divisional Round Seed 2 vs Seed 4</h1>
			...
			<div class = "row">
				<div class="col-lg-6 left">
					<input type="button" name = "afcdiv2winner" id="afcwc1-3"> 

				</div>

				<div class="col-lg-6 right">
					<input type="button" name = "afcdiv2winner" id="afcwc1-6">
				</div>
